...
\newline \includegraphics[scale=0.7]{with_edge_or_not.jpg}
\newline 2. Окружность: \(S^1 = \{(x,y)\in \mathbb{R}^2| x^2 + y^2 =1\}\) 
\newline \includegraphics[scale=0.85]{circle.jpg}
\newpage 3. Сфера: \(S^2 = \{(x,y,z)\in\mathbb{R}^3| x^2+y^2+z^2=1\}\)
\newline \includegraphics[scale=0.5]{diversity_without edge.jpg}
...
\end{cases}
\end{equation*}
\includegraphics[scale=0.5]{tor_without_edge.jpg}
\newpage 5. Цилиндр.
