...
\newline \includegraphics[scale=0.7]{function1.jpg}
\newline 2. Окружность: \(S^1 = \{(x,y)\in \mathbb{R}^2| x^2 + y^2 =1\}\) 
\newline \includegraphics[scale=0.85]{а2.jpg}
\newpage 3. Сфера: \(S^2 = \{(x,y,z)\in\mathbb{R}^3| x^2+y^2+z^2=1\}\)
\newline \includegraphics[scale=0.5]{ф3.png}
...
\end{cases}
\end{equation*}
\includegraphics[scale=0.5]{2с.png}
\newpage 5. Цилиндр.
